        ...
        <div className="feature-cards">
          <div className="card">
            ...
            <div className="card-content">
              ...
              <a
                href="https://blkgrn.com/blogs/articles/how-home-gardens-are-helping-homeowners-combat-climate-change?srsltid=AfmBOoqzgkT6hm9MZXBygVUuq58a6y3nNyfb4Ohpoe7hPPSE0_ATeeqP"
               >
                Read More
              </a>
            </div>
      ...
      <section className="about">
        ...
        <div className="about-content">
          ...
          <div className="about-image">
            <img src="/mission.jpeg" alt="Community" />
          </div>
        </div>
      </section>
